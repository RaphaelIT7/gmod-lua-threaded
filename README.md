...
You can download the latest version(which exist for only 1 day) from the last run workflow, which you can find [here](https://github.com/RaphaelIT7/gmod-lua-threaded/actions/workflows/compile.yml)  
Or you can download the last working version(which exist for 1 month) which was tested from [here](https://github.com/RaphaelIT7/gmod-lua-threaded/actions/workflows/working-versions.yml)  
