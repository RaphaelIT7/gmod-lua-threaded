// NOTE: Remove this file and use gameinterface.h again when my PR got merged.
...
public:
	...
	virtual bool 			GMOD_CheckPassword( unsigned long long, char const*, char const*, char const*, char const*, char *, uint ) OVERRIDE;
